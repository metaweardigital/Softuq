...
const alertVariants = cva(
  "relative rounded-[var(--ds-radius-card)] border p-[var(--ds-space-card-sm)] text-sm [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-1/2 [&>svg]:-translate-y-1/2 [&>svg]:h-4 [&>svg]:w-4 [&:has(svg)]:pl-11",
  {
    variants: {
      variant: {
