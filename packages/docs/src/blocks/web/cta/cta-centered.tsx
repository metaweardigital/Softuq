...
export default function Cta01() {
  return (
    <section className="px-[var(--ds-space-page-x)] py-[var(--ds-space-section-y)]">
      <div
        className="relative mx-auto max-w-4xl rounded-[var(--ds-radius-card)] border border-edge-subtle overflow-hidden px-[var(--ds-space-page-x)] py-[var(--ds-space-section-y)] text-center"
        style={{
          background:
