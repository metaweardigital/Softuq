...
export default function GettingStartedPage() {
  return (
    <>
      <h1 className="text-3xl font-bold text-text-primary tracking-tight">Getting Started</h1>
      <p className="text-text-secondary mt-2 text-lg">Add DesignYstem to your project in 2 minutes.</p>
