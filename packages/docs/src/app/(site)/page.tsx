...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <section className="space-y-4">
      ...
      <div className="rounded-[var(--ds-radius-card)] border border-border-subtle bg-bg-card p-6 space-y-6">
        {children}
      </div>
    </section>
  );
        ...
        <div className="max-w-6xl mx-auto px-6 py-12 space-y-12">
          ...
          <Section title="Colors">
            <div className="space-y-6">
              ...
              <p className="text-xs font-medium text-text-muted uppercase tracking-wide">
                Non-changing{" "}
                <span className="text-text-dimmed font-normal normal-case">
              ...
              {[
                ...
                <div key={scale.name} className="flex flex-wrap items-center gap-2">
                  <span className="text-xs font-mono text-text-muted w-10">{scale.name}</span>
                  {[5, 10, 20, 40, 70, 90, 100].map((step) => (
                    <div key={step} className="flex items-center gap-2">
                      <div
                        className="h-6 w-6 rounded-[var(--ds-radius-checkbox)] border border-border-subtle overflow-hidden"
                        style={{
                ...
                <Accordion variant="default">
                  ...
                  <AccordionItem value="item-4">
                    ...
                    <AccordionContent>
                      ...
                      override. Dark mode is default, switch to light with <Code>data-theme=&quot;light&quot;</Code> on
                      your root element.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
